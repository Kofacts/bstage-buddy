    ...
    <div class="relative">
        <div class="h-[83.4vh] max-h-[83.4vh] overflow-y-scroll pt-[29px] flex flex-col gap-[58.35px]"> 
            ...
            <div v-if="images.length > 0">
                <div class="h-40 w-32" v-for="(image,index) in images" :key="index"> 
                    <img :src="image" />
                </div>
            </div>
            <div v-else class="overflow-hidden" style="display:-webkit-box"> 
                 <svg v-for="n in 5" :key="n" width="202" class="opacity-40" height="278" viewBox="0 0 202 278" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="p-[20px] flex flex-row  items-center gap-[15px] justify-center"> 
                ...
                <button class="rounded-[15px] bg-nano-light w-full h-[53px] w-[288px] flex items-center justify-center text-nano-dark gap-[15px] text-[19px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="14" viewBox="0 0 18 14" fill="none">
                        <path d="M0.778564 8.30735L5.3729 12.8235L17.2214 1.17651" stroke="#3E1821" stroke-linejoin="round"/>
                    </svg>
                    Save
                </button>
            </div>
        </div>
        <div class="h-[80vh] bg-nano-dark flex flex-col items-center justify-center text-[19px] gap-[34.2px] fixed top-0 w-full"> 
            <svg width="96" height="90" viewBox="0 0 96 90" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M89.8692 49.3637C75.1502 52.7312 63.8216 64.4774 60.9931 79.3019C57.6257 64.5829 45.8794 53.2543 31.0549 50.4259C45.7739 47.0584 57.1025 35.3121 59.931 20.4876C63.2984 35.2066 75.0447 46.5352 89.8692 49.3637Z" fill="#E5EEB9" stroke="#E5EEB9" stroke-width="1.75" stroke-linejoin="round"/>
                <path d="M39.4635 21.7263C30.4727 23.7793 23.5546 30.957 21.8273 40.0133C19.7744 31.0225 12.5966 24.1044 3.54035 22.3771C12.5311 20.3242 19.4492 13.1464 21.1765 4.09015C23.2294 13.0809 30.4072 19.999 39.4635 21.7263Z" fill="#E5EEB9" stroke="#E5EEB9" stroke-width="1.75" stroke-linejoin="round"/>
                <path d="M38.9089 76.1403C33.5573 77.3602 29.4387 81.6319 28.4139 87.0231C27.1939 81.6714 22.9222 77.5528 17.5311 76.528C22.8827 75.308 27.0013 71.0364 28.0261 65.6452C29.2461 70.9968 33.5178 75.1155 38.9089 76.1403Z" fill="#E5EEB9" stroke="#E5EEB9" stroke-width="1.75" stroke-linejoin="round"/>
            </svg>
