        ...
        <div
            ...
            <div id="script-wrapper" :class="{ 'pt-36': modeType == 'editScript' }"
                ...
                <div :class="`mt-${index} pb-[50px]`" v-for="(page, index) in script.pages" :key="page.reference">
                    ...
                    <draggable 
                    v-model="script.pages[index].lines" 
                    group="people" 
                    @start="drag=true" 
                    @end="drag=false" 
                    item-key="id">
                        <template #item="{element}">
                            <div class="relative" :class="{ 'ml-20': element.character?.is_self }">
                                <button class="absolute -left-3 top-2 flex items-center justify-center bg-[#f8ffd2] h-6 w-6 rounded-full">
                                ...
                                <button class="absolute right-0 top-0 flex items-center justify-center bg-red-700 h-6 rounded-full w-6">
