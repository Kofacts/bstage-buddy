<template>
    <div :class="`relative${loaded ? '' : ' blur'}`">
        ...
        <div
            class="h-[83.4vh] max-h-[83.4vh] overflow-y-scroll p-[10px] pt-12 pl-0 pr-0 pb-0 flex flex-col bg-nano-dark">
            <div class="fixed top-8 w-full z-20">
                <div class="flex items-center justify-start gap-[70px] pl-[10px] pr-[10px] pb-[15px] pt-[29px] bg-nano-dark">
