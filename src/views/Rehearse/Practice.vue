    ...
    <div :class="`relative${loaded ? '' : ' blur'}`">
        ...
        <div
            ...
            <div :class="{ 'pt-36': modeType == 'rehearse' && isPlayingAudio }"
                class="h-[10000px] relative bg-nano-light flex flex-col gap-[10px] text-black pt-16">
                ...
                <div class="mt-5 pb-[50px]" v-for="(page, index) in script.pages" :key="index">
                    <div class="flex-col mb-[10px] bg-[#DCE2B3]" :class="{ 'pl-4 pr-2': line.character.is_self }"
                        v-for="line in script.pages[index].lines">
                        {{ line.character.name }}
                        <div class="w-1/6" v-if="currentLine?.reference === line.reference">
                        ...
                        <div class="w-5/6 h-auto outline-none p-[10px] pb-0 rounded-[10px] text-center text-[16px] text-nano-dark"
        ...
        <div
            class="pb-60 border-t-[0.1px] border-t border-nano-dark z-[999] h-[127px] bg-nano-light fixed bottom-0 w-full pt-[15px] pl-[30px] pr-[30px] flex justify-between items-center">
